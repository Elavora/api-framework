...
namespace Elavora\Api;

use Elavora\Api\Contracts\Extension;
use Elavora\Api\Http\HttpKernel;
use Elavora\Api\Http\HttpMethod;
use Elavora\Api\Http\Request;
use Elavora\Api\Http\Response;
use Elavora\Api\Http\ResponseEmitter;
use Elavora\Api\Routing\ControllerResolver;
use Elavora\Api\Routing\ConventionRouteResolver;
use Elavora\Api\Routing\Router;

/**
 * Ponto principal de configuracao e execucao de uma aplicacao Elavora API.
 *
...
final class Application
{
    ...
    /**
     * Cria uma aplicacao Elavora API.
     *
